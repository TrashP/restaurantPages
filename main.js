...
eval("\n\nmodule.exports = function (url, options) {\n  if (!options) {\n    options = {};\n  }\n\n  if (!url) {\n    return url;\n  }\n\n  url = String(url.__esModule ? url.default : url); // If url is already wrapped in quotes, remove them\n\n  if (/^['\"].*['\"]$/.test(url)) {\n    url = url.slice(1, -1);\n  }\n\n  if (options.hash) {\n    url += options.hash;\n  } // Should url be wrapped?\n  // See https://drafts.csswg.org/css-values-3/#urls\n\n\n  if (/[\"'() \\t\\n]|(%20)/.test(url) || options.needQuotes) {\n    return \"\\\"\".concat(url.replace(/\"/g, '\\\\\"').replace(/\\n/g, \"\\\\n\"), \"\\\"\");\n  }\n\n  return url;\n};\n\n//# sourceURL=webpack://restaurantpages/./node_modules/css-loader/dist/runtime/getUrl.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _styles_styles_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./styles/styles.css */ \"./src/styles/styles.css\");\n/* harmony import */ var _mainPage_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./mainPage.js */ \"./src/mainPage.js\");\n/* harmony import */ var _foodMenuPage_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./foodMenuPage.js */ \"./src/foodMenuPage.js\");\n/* harmony import */ var _drinksPage_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./drinksPage.js */ \"./src/drinksPage.js\");\n/* harmony import */ var _dessertPage_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./dessertPage.js */ \"./src/dessertPage.js\");\n\n\n\n\n\n\n(0,_mainPage_js__WEBPACK_IMPORTED_MODULE_1__.mainPageHeader)(); \n(0,_mainPage_js__WEBPACK_IMPORTED_MODULE_1__.mainPageFooter)();\n(0,_mainPage_js__WEBPACK_IMPORTED_MODULE_1__.initialMainPage)();\n(0,_mainPage_js__WEBPACK_IMPORTED_MODULE_1__.changeCity)();\n\nconst logoDiv = document.getElementById('logoDiv');\nlogoDiv.addEventListener('click', function() {\n    const content = document.getElementById('content');\n    const sidebar = document.getElementById('sidebar');\n    const reserve = document.getElementById('reserve');\n\n    content.removeChild(sidebar);\n    content.removeChild(reserve);\n    (0,_mainPage_js__WEBPACK_IMPORTED_MODULE_1__.initialMainPage)();\n    (0,_mainPage_js__WEBPACK_IMPORTED_MODULE_1__.changeCity)();\n})\n\nconst foodDiv = document.getElementById('foodDiv');\nfoodDiv.addEventListener('click', function() {\n    const content = document.getElementById('content');\n    const sidebar = document.getElementById('sidebar');\n    const reserve = document.getElementById('reserve');\n\n    content.removeChild(sidebar);\n    content.removeChild(reserve);\n    (0,_foodMenuPage_js__WEBPACK_IMPORTED_MODULE_2__.foodMenuPageSidebar)();\n    (0,_foodMenuPage_js__WEBPACK_IMPORTED_MODULE_2__.foodMenuPageReserve)();\n    (0,_foodMenuPage_js__WEBPACK_IMPORTED_MODULE_2__.burgersMenu)();\n    (0,_foodMenuPage_js__WEBPACK_IMPORTED_MODULE_2__.foodSidebar)();\n})\n\nconst drinksDiv = document.getElementById('drinksDiv');\ndrinksDiv.addEventListener('click', function() {\n    const content = document.getElementById('content');\n    const sidebar = document.getElementById('sidebar');\n    const reserve = document.getElementById('reserve');\n\n    content.removeChild(sidebar);\n    content.removeChild(reserve);\n    (0,_drinksPage_js__WEBPACK_IMPORTED_MODULE_3__.drinksPageSidebar)();\n    (0,_drinksPage_js__WEBPACK_IMPORTED_MODULE_3__.drinksPageReserve)();\n    (0,_drinksPage_js__WEBPACK_IMPORTED_MODULE_3__.cocktailsMenu)();\n    (0,_drinksPage_js__WEBPACK_IMPORTED_MODULE_3__.drinksSidebar)();\n})\n\nconst dessertDiv = document.getElementById('dessertDiv');\ndessertDiv.addEventListener('click', function() {\n    const content = document.getElementById('content');\n    const sidebar = document.getElementById('sidebar');\n    const reserve = document.getElementById('reserve');\n\n    content.removeChild(sidebar);\n    content.removeChild(reserve);\n    (0,_dessertPage_js__WEBPACK_IMPORTED_MODULE_4__.dessertsPageSidebar)();\n    (0,_dessertPage_js__WEBPACK_IMPORTED_MODULE_4__.dessertPageReserve)();\n    (0,_dessertPage_js__WEBPACK_IMPORTED_MODULE_4__.dessertMenu)();\n})\n\n\n//# sourceURL=webpack://restaurantpages/./src/index.js?");
